...
(cl:defmethod cl:initialize-instance :after ((m <My2Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'My2Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name SpiderRobot-msg:<My2Num> is deprecated: use SpiderRobot-msg:My2Num instead.")))

(cl:ensure-generic-function 'cha-val :lambda-list '(m))
(cl:defmethod cha-val ((m <My2Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader SpiderRobot-msg:cha-val is deprecated.  Use SpiderRobot-msg:cha instead.")
  (cha m))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <My2Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader SpiderRobot-msg:pos-val is deprecated.  Use SpiderRobot-msg:pos instead.")
  (pos m))
