...
(cl:defmethod cl:initialize-instance :after ((m <MyArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name SpiderRobot-msg:<MyArray> is deprecated: use SpiderRobot-msg:MyArray instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <MyArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader SpiderRobot-msg:data-val is deprecated.  Use SpiderRobot-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <MyArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader SpiderRobot-msg:size-val is deprecated.  Use SpiderRobot-msg:size instead.")
  (size m))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <MyArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader SpiderRobot-msg:command-val is deprecated.  Use SpiderRobot-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <MyArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader SpiderRobot-msg:speed-val is deprecated.  Use SpiderRobot-msg:speed instead.")
  (speed m))
